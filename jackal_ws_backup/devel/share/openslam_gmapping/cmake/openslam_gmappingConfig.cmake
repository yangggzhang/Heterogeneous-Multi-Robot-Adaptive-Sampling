...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/administrator/catkin_ws/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/administrator/catkin_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/administrator/catkin_ws/install)
...
if(NOT "/home/administrator/catkin_ws/src/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/administrator/catkin_ws/src/openslam_gmapping/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ROS Orphaned Package Maintainers <ros-orphaned-packages@googlegroups.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/administrator/catkin_ws/src/openslam_gmapping/${idir}'.  Ask the maintainer 'ROS Orphaned Package Maintainers <ros-orphaned-packages@googlegroups.com>' to fix it.")
    endif()
