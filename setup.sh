#!/bin/sh
sudo apt-get install python-catkin-tools sshpass
sudo apt-get install ros-kinetic-octomap ros-kinetic-octomap-msgs ros-kinetic-costmap-2d ros-kinetic-grid-map-ros ros-kinetic-robot-localization ros-kinetic-move-base-msgs ros-kinetic-move-base
